...
export default function AuthLayout() {
 ...
 <span className="text-3xl font-black text-gray-900 tracking-tight">Signflow</span>
 </div>
 <p className="text-gray-500 font-medium">Digital signatures made simple and secure.</p>
 </div>
 
 <div className="bg-white rounded-3xl shadow-2xl shadow-slate-200/50 border border-white p-8 backdrop-blur-xl">
 <Outlet />
 </div>
